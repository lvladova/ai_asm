...
def create_dataset(dataset, look_back=1):
    """
    Create LSTM dataset with specified look back window size.
    """
    X, Y = [], []
...
def predict_next_value(model, raw_data, scaler, look_back):
    """
    Predict the next value in the sequence using the trained model.
    """
    # Ensure input data is in the correct format and scale
...
# Predict using the last few days from the training set
